...
INSERT INTO `textra_db`.`questions` (`Q_qeustion`, `isMultipuleAns`, `Q_mediaType`, `Q_media`, `Q_correctFB`, `Q_notCorrectFB`, `Q_skill`, `Q_difficulty`, `Q_proffession`, `Q_reported`, `Q_approved`, `Q_disabled`, `Q_owner`) VALUES ('לפניך פרסומת - מה היא המטרה העיקרית של יוצרי הפרסומת?', '0','img','img/selfie.jpg','מצוין! זיהית שהמטרה בפרסומת היא לעודד רכישת מוצרים כחול לבן. הגיוני כשחושבים על כך שהיוצרים הם משרד הכלכלה,"מיוצר בישראל" והתאחדות התעשיינים בישראל...','אמנם התשובה שציינת היא מטרה של יוצרי הפרסומת אך זו אינה מטרתם המרכזית.  כדאי לשים לב מי הם היוצרים של הפרסומת...','זיהוי מטרה מרכזית','קלה','הבעה','0','0','0','1','0','1');
...
INSERT INTO `textra_db`.`questions` (`Q_qeustion`, `isMultipuleAns`, `Q_mediaType`, `Q_media`, `Q_correctFB`, `Q_notCorrectFB`, `Q_skill`, `Q_difficulty`, `Q_proffession`, `Q_reported`, `Q_approved`, `Q_disabled`, `Q_owner`) VALUES ('לפניך כרזה שהתפרסמה בנקודות המכירה של מפעל הפיס. מה מטרתה?', '0','img','img/good.jpg','אכן. אם לא הרווחת - לפחות תדע שהפסדת כסף למטרות טובות.','מפעל הפיס אמנם תורם ומעורב אך מהי מטרתו באמירות אלו?','זיהוי מטרה מרכזית','קלה','הבעה','0','0','0','1','0','1');
INSERT INTO `textra_db`.`questions` (`Q_qeustion`, `isMultipuleAns`, `Q_mediaType`, `Q_media`, `Q_correctFB`, `Q_notCorrectFB`, `Q_skill`, `Q_difficulty`, `Q_proffession`, `Q_reported`, `Q_approved`, `Q_disabled`, `Q_owner`) VALUES ('מהי מטרתו המרכזית של כותב הקטע? ', '0','img','img/crime.jpg','הכותב אכן פונה אל המדינה ודורש ממנה להפעיל צעדים חוקיים כדי להילחם בארגוני הפשיעה. ','כותב הקטע אכן מתייחס לתשובה שציינת, אך לא זו מטרת הטקסט שלו.  מומלץ לבחון שוב למי פונה הכותב בדבריו. ','זיהוי מטרה מרכזית','בינונית','הבעה','0','0','0','1','0','1');
