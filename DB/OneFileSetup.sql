...
INSERT INTO `textra_db`.`questions` (`Q_qeustion`, `isMultipuleAns`, `Q_mediaType`, `Q_media`, `Q_correctFB`, `Q_notCorrectFB`, `Q_skill`, `Q_difficulty`, `Q_proffession`, `Q_reported_Offensive`, `Q_reported_Question`, `Q_reported_Answer`,`Q_approved`, `Q_disabled`, `Q_owner`) VALUES ('לפניך פרסומת - מה היא המטרה העיקרית של יוצרי הפרסומת?', '0','img','http://oi64.tinypic.com/j9sfgg.jpg','מצוין! זיהית שהמטרה בפרסומת היא לעודד רכישת מוצרים כחול לבן. הגיוני כשחושבים על כך שהיוצרים הם משרד הכלכלה,"מיוצר בישראל" והתאחדות התעשיינים בישראל...','אמנם התשובה שציינת היא מטרה של יוצרי הפרסומת אך זו אינה מטרתם המרכזית.  כדאי לשים לב מי הם היוצרים של הפרסומת...','זיהוי מטרה מרכזית','קלה','הבעה','0','0','0','1','0','1');
INSERT INTO `textra_db`.`questions` (`Q_qeustion`, `isMultipuleAns`, `Q_mediaType`, `Q_media`, `Q_correctFB`, `Q_notCorrectFB`, `Q_skill`, `Q_difficulty`, `Q_proffession`, `Q_reported_Offensive`, `Q_reported_Question`, `Q_reported_Answer`,`Q_approved`, `Q_disabled`, `Q_owner`) VALUES ('לפניך קטע קצר הלקוח מאתר מפעל הפיס, קרא אותו ונסה לחשוב מדוע מופיע קטע כזה באתר מפעל הפיס?', '0','img','http://oi63.tinypic.com/2up9x1y.jpg','מפעל הפיס מנסה להבהיר שסיכויי הזכייה אינם גבוהים כדי להימנע מטענות עתידיות. ','מפעל הפיס הוא שפרסם את הדברים באתר, ולכן מן הסתם הם נועדו לשרת מטרה שלו. מה יכולה להיות מטרה זו?','זיהוי מטרה מרכזית','בינונית','הבעה','0','0','0','1','0','1');
INSERT INTO `textra_db`.`questions` (`Q_qeustion`, `isMultipuleAns`, `Q_mediaType`, `Q_media`, `Q_correctFB`, `Q_notCorrectFB`, `Q_skill`, `Q_difficulty`, `Q_proffession`, `Q_reported_Offensive`, `Q_reported_Question`, `Q_reported_Answer`,`Q_approved`, `Q_disabled`, `Q_owner`) VALUES ('לפניך כרזה שהתפרסמה בנקודות המכירה של מפעל הפיס. מה מטרתה?', '0','img','http://oi66.tinypic.com/73m1oi.jpg','אכן. אם לא הרווחת - לפחות תדע שהפסדת כסף למטרות טובות.','מפעל הפיס אמנם תורם ומעורב אך מהי מטרתו באמירות אלו?','זיהוי מטרה מרכזית','קלה','הבעה','0','0','0','1','0','1');
INSERT INTO `textra_db`.`questions` (`Q_qeustion`, `isMultipuleAns`, `Q_mediaType`, `Q_media`, `Q_correctFB`, `Q_notCorrectFB`, `Q_skill`, `Q_difficulty`, `Q_proffession`, `Q_reported_Offensive`, `Q_reported_Question`, `Q_reported_Answer`,`Q_approved`, `Q_disabled`, `Q_owner`) VALUES ('מהי מטרתו המרכזית של כותב הקטע? ', '0','img','http://oi68.tinypic.com/11b4vmq.jpg','הכותב אכן פונה אל המדינה ודורש ממנה להפעיל צעדים חוקיים כדי להילחם בארגוני הפשיעה. ','כותב הקטע אכן מתייחס לתשובה שציינת, אך לא זו מטרת הטקסט שלו.  מומלץ לבחון שוב למי פונה הכותב בדבריו. ','זיהוי מטרה מרכזית','בינונית','הבעה','0','0','0','1','0','1');
...
/*INSERT INTO `textra_db`.`questions` (`Q_qeustion`, `isMultipuleAns`, `Q_mediaType`, `Q_media`, `Q_correctFB`, `Q_notCorrectFB`, `Q_skill`, `Q_difficulty`, `Q_proffession`,  `Q_reported_Offensive`, `Q_reported_Question`, `Q_reported_Answer`,`Q_approved`, `Q_disabled`, `Q_owner`) VALUES ('how much "bla" are there?', '1','text',
'bla bla bla','You are On FIREEEE','You like shit!','רב','קלה','הבעה','0','0','0','1','0','1');9*/
...
;/*INSERT INTO `textra_db`.`answers` (`answer`, `Q_id`, `isCorrect`) VALUES ('more then 0','12','1');
INSERT INTO `textra_db`.`answers` (`answer`, `Q_id`, `isCorrect`) VALUES ('less then 4','12','1');
INSERT INTO `textra_db`.`answers` (`answer`, `Q_id`, `isCorrect`) VALUES ('too much to count','12','0');
INSERT INTO `textra_db`.`answers` (`answer`, `Q_id`, `isCorrect`) VALUES ('none','12','0')
;*/
